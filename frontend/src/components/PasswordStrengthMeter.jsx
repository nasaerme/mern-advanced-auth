  ...
  return (
    <div className="mt-2">
      <div className="flex justify-between items-center mb-1">
        <span className="text-cs text-gray-400">Password strength</span>
        <span className="text-cs text-gray-400">{getStrengthText(strength)}</span>
      </div>
      <div className="flex spcae-x-1">
        {[...Array(4)].map((_,index)=>(
